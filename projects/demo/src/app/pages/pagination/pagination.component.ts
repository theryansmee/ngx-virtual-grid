...
export class PaginationComponent {
	...
	constructor() {
		...
		this.#route.queryParamMap.pipe(takeUntilDestroyed()).subscribe((params: ParamMap) => {
			// SSR guard: the page is prerendered. the fake API timers and scroll
			// positioning only make sense in the browser, so the prerendered HTML
			// ships the loading state and the client initialises after hydration.
